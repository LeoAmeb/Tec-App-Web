@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Tablero')])
      ...
      <form class="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-success text-center">
            <h4 class="card-title"><strong>{{ __('Registrarse con') }}</strong></h4>
          ...
          <div class="card-body ">
            <p class="card-description text-center">{{ __('O a la antigua') }}</p>
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                ...
                {{ __('Estoy deacuerdo con ') }} <a href="#">{{ __('la política de privacidad') }}</a>
              </label>
            </div>
          </div>
