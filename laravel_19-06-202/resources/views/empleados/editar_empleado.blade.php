...
@section ('contenido')
    <div class="righ_col" role="main">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                <form action="{{ url('/empleados/'.$empleados->id) }}"  enctype="multipart/form-data" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                    {{csrf_field()}}
                    {{ method_field('PUT') }}
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="text" id="nombres" name="nombres" required="required" class="form-control" value="{{ $empleados->nombres }}">
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="text" id="apellidos" name="apellidos" required="required" class="form-control" value="{{ $empleados->apellidos }}">
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="text" id="cedula" name="cedula" required="required" class="form-control" value="{{ $empleados->cedula }}">
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="text" id="email" name="email" required="required" class="form-control" value="{{ $empleados->email }}">
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="text" id="lugar_nacimiento" name="lugar_nacimiento" required="required" class="form-control" value="{{ $empleados->lugar_nacimiento }}">
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="text" id="telefono" name="telefono" required="required" class="form-control" value="{{ $empleados->telefono }}">
                        </div>
                    </div>

                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="nombre"> Departamento <spam class="required">*</spam>
                        </label>
                        <div class="col-md-6 col-sm-6">
                        <select name="dep_id" class="form-control" id="exampleFormControlSelect1">
